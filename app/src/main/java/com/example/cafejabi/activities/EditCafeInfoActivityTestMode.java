...
//
//
//public class EditCafeInfoActivityTestMode extends AppCompatActivity implements View.OnClickListener {
//
//    private final String TAG = "EditCafeInfoActivity";
//    private Context mContext = EditCafeInfoActivityTestMode.this;
//
...
//            @Override
//            public void onSuccess(DocumentSnapshot documentSnapshot) { Log.d(TAG, "getting Cafe : success");
...
//
//                    progressDialog.dismiss();
//                    Toast.makeText(EditCafeInfoActivityTestMode.this, "카페 정보 수정 완료", Toast.LENGTH_SHORT).show();
//                    goActivity(MainActivity.class);
//                }
